...
// Vendored from React Bits (FloatingLines, JS + CSS variant), ported to
// TypeScript. Raw Three.js by design. Shaders and render logic are preserved
// verbatim from source; only types and the container styling were adapted for
// this codebase. Graceful WebGL / reduced-motion degradation is handled by the
// HeroBackground wrapper, not here.
